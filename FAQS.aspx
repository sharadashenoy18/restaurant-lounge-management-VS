<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FAQS.aspx.cs" Inherits="Sharada.FAQS" %>
...
<div class="container">
    ...
    <div class="question-header">
       ...
       <div>
    <asp:Label ID="Label1" runat="server" Text="ACCOMMODATION RELATED QUESTIONS:" style="font-size: 28px;" />
    <asp:Button ID="AccommodationPlusButton" runat="server" Height="36px" Text="+" Width="36px" CssClass="btn btn-link"
        ...
        OnClientClick="return toggleQuestions('accommodationQuestions');" /></div>
...
<div id="accommodationQuestions" class="question-container" style="margin-left: 50px; display: none;">
    ...
    <div class="white-container1">
        <div class="question-header">
            ...
            <b><span style="font-size:24px;">Question 2: Another question?</span></b>
        </div>
    </div>
    ...
    <div class="white-container1">
        <div class="question-header">
            ...
            <b><span style="font-size:24px;">Question 3: Your third question?</span></b>
        </div>
    </div>

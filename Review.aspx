<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Review.aspx.cs" Inherits="Sharada.Review" %>
     ...
     <a class="dropdown-item" href="Login.aspx">LOGOUT</a> </div> </li>
         ...
         <br/>
             ...
             <div class="special-container" id="specialContainer">
                 <asp:GridView ID="GridViewReviews" runat="server" AutoGenerateColumns="False" Width="100%" style="text-align:left; column-gap:5px;">
    <Columns>
        <asp:TemplateField HeaderText="REVIEWS AND FEEDBACKS BY OUR CUSTOMERS">
            <ItemTemplate>
...
<center>
  <textarea id="txtarea1" runat="server" placeholder="WRITE YOUR REVIEW" style="width: 1500px; height: 75px; margin-right: 10px;"></textarea>
  <br />
<asp:Button ID="Button1" runat="server" Text="Button" Height="47px" Width="206px" style="background-color: #007bff;" OnClick="Button1_Click1" />
    <br />

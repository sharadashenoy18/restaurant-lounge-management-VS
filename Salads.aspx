<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salads.aspx.cs" Inherits="Sharada.Salads" %>
...
<center>
    <b>
        <asp:Label ID="Label1" runat="server" Text="~~~SALADS~~~" Font-Size="38px"></asp:Label>
    </b>
...
<center>
    <table>
        <tr>
            <td class="auto-style1">
                <asp:Image ID="Image1" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Asian Sesame Noodle Salad.png" style="margin-left: 25px; margin-right: 28px" />
                <asp:Label ID="Label2" runat="server" Text="Asian Sesame Noodle Salad" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
                ...
                <asp:Label ID="LabelPrice1" runat="server" Text="169 per plate" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
             ...
             <td class="auto-style1">
     <b><asp:Image ID="Image2" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Summer Panzanella Salad.png" style="margin-left: 25px;" /></b>
     <asp:Label ID="Label3" runat="server" Text="Summer Panzanella Salad" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     ...
     <asp:Label ID="Label5" runat="server" Text="145 per plate" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     <asp:Button ID="Button1" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button1_Click"/>
             ...
             <td class="auto-style1">
     <asp:Image ID="Image3" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Raita.png" style="margin-left: 25px; margin-right: 28px" />
     <asp:Label ID="Label6" runat="server" Text="Riata" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     ...
     <asp:Label ID="Label8" runat="server" Text="155 per plate" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     <asp:Button ID="Button2" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button2_Click"/>
             ...
             <td class="auto-style1">
     <asp:Image ID="Image4" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Spinach and Strawberry Salad.png" style="margin-left: 25px; margin-right: 28px" />
     <asp:Label ID="Label9" runat="server" Text="Spinach and Strawberry Salad" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     ...
     <asp:Label ID="Label11" runat="server" Text="144 per plate" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     <asp:Button ID="Button3" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button3_Click"/>
        ...
        <tr>
            <td>&nbsp;</td>
               ...
               <tr>
           <td>
               <asp:Image ID="Image5" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Roasted Vegetable Salad.jpg" style="margin-left: 25px; margin-right: 28px" />
               <asp:Label ID="Label12" runat="server" Text="Roasted Vegetable Salad" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
               ...
               <asp:Label ID="Label14" runat="server" Text="135 per plate" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
            ...
            <td>
    <b><asp:Image ID="Image6" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Chickpea and Avocado Salad.jpg" style="margin-left: 25px;" /></b>
    <asp:Label ID="Label15" runat="server" Text="Chickpea and Avocado Salad" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    ...
    <asp:Label ID="Label17" runat="server" Text="147 per plate" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    <asp:Button ID="Button5" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button5_Click"/>
            ...
            <td>
    <asp:Image ID="Image7" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Capsicum Salad.jpg" style="margin-left: 25px; margin-right: 28px" />
    <asp:Label ID="Label18" runat="server" Text="Capsicum Salad" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    ...
    <asp:Label ID="Label20" runat="server" Text="154 per plate" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    <asp:Button ID="Button6" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button6_Click"/>
            ...
            <td>
    <asp:Image ID="Image8" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Watermelon and Feta Salad.jpg" style="margin-left: 25px; margin-right: 28px" />
    <asp:Label ID="Label21" runat="server" Text="Watermelon and Feta Salad" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    ...
    <asp:Label ID="Label23" runat="server" Text="165 per plate" style="text-align: center; display: block; margin-top: 5px;" EnableTheming="False"></asp:Label>

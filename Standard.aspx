<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Standard.aspx.cs" Inherits="Sharada.Standard" %>
<!DOCTYPE html>
     ...
     <a class="dropdown-item" href="Login.aspx">LOGOUT</a> </div> </li>
            ...
            <div class="container body-content">
                <center>
                    <br />
                    <b>
                    <asp:Label ID="Label1" runat="server" Text="~~~STANDARD ROOMS~~~" Font-Size="38px"></asp:Label> 
                    <br />
                    <hr/></b></center> </div> </div>


   <div class="image-container" style="position: relative; background-color:beige">
    <asp:Image ID="Image1" runat="server" Height="415px" Width="642px" ImageUrl="~/Images/standard1.png" style="padding-left:40px; " /> <b> <i>
       <asp:Label ID="Label2" runat="server"  Text="CLASSIC COMFORT ROOM" style="position: absolute; top: 10px; left: 1000px; font-size: 29px;"/> </b> 
        ...
        <br/><span class="arrow">&#9656;</span><b> PRICE : </b>₹ 6,000 per day</p>
<asp:Button ID="Button2" runat="server" Text="CHECK AVAILABILITY" style="top:360px; position:absolute; left:1050px; height: 48px; width: 288px; background-color:black; color:white;" OnClick="Button2_Click" />
       ...
       <br/> </div>  <br/><br/>
        ...
        <div class="image-container" style="position:relative; background-color:beige">
            <asp:Image ID="Image2" runat="server" Height="415px" Width="642px" ImageUrl="~/Images/room2.jpg" style="padding-left:40px; " /> <b> <i>
       <asp:Label ID="Label3" runat="server"  Text=" COMFORT BLISS ROOM" style="position: absolute; top: 10px; left: 1000px; font-size: 29px;"/> </b> 
         <p style="position: absolute; top: 60px; left: 680px; font-size: 20px;">

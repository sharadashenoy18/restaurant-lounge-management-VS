<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="food.aspx.cs" Inherits="Sharada.Paynow1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="pay-now-container">
        <b><center>
        <asp:Label ID="Label1" runat="server" style="font-size:25px;" Text="Like our delicious meals, your payment is handled with the utmost care and security."></asp:Label>

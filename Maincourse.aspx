<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Maincourse.aspx.cs" Inherits="Sharada.Maincourse" %>
...
<center>
    <b>
        <asp:Label ID="Label1" runat="server" Text="~~~MAIN COURSE~~~" Font-Size="38px"></asp:Label>
    </b>

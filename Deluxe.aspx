<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Deluxe.aspx.cs" Inherits="Sharada.Deluxe" %>
<!DOCTYPE html>
     ...
     <a class="dropdown-item" href="Login.aspx">LOGOUT</a> </div> </li>
            ...
            <div class="container body-content">
                <center>
                    <br />
                    <b>
                    <asp:Label ID="Label1" runat="server" Text="~~~DELUXE ROOMS~~~" Font-Size="38px"></asp:Label> 
                    <br />
                    <hr/></b></center> </div> </div>


   <div class="image-container" style="position: relative; background-color:beige">
    <asp:Image ID="Image1" runat="server" Height="415px" Width="642px" ImageUrl="~/Images/de1.png" style="padding-left:40px; " /> <b> <i>
       <asp:Label ID="Label2" runat="server"  Text=" DELUXE KING ROOM" style="position: absolute; top: 10px; left: 1000px; font-size: 29px;"/> </b> 
         <p style="position: absolute; top: 60px; left: 680px; font-size: 20px;">
Step into luxury with our Deluxe King Room, featuring a spacious layout and a plush king-sized bed for a restful night's sleep. Modern amenities and elegant decor create a serene atmosphere, ensuring a comfortable and memorable stay. Our Deluxe King Room offers a luxurious retreat with a spacious layout and a plush king-sized bed, providing the perfect setting for relaxation.       <p style="position: absolute; top: 160px; left: 700px; font-size: 20px;">
        <br/> <span class="arrow">&#9656;</span> <b> AREA : </b> 50sq Mt
        <br/> <span class="arrow">&#9656;</span><b> PERSONS : </b> Upto 4 guests
        <br/><span class="arrow">&#9656;</span> <b> WIFI : </b> Free Upto 4 devices
...
<asp:Button ID="Button2" runat="server" Text="CHECK AVAILABILITY" style="top:360px; position:absolute; left:1050px; height: 48px; width: 288px; background-color:black; color:white;" OnClick="Button2_Click" />
       ...
       <br/> </div>  <br/><br/>
        ...
        <div class="image-container" style="position:relative; background-color:beige">
            <asp:Image ID="Image2" runat="server" Height="415px" Width="642px" ImageUrl="~/Images/de2.png" style="padding-left:40px; " /> <b> <i>
       <asp:Label ID="Label3" runat="server"  Text=" DELUXE SUITE ROOM" style="position: absolute; top: 10px; left: 1000px; font-size: 29px;"/> </b> 
         <p style="position: absolute; top: 60px; left: 680px; font-size: 20px;">
Indulge in the epitome of luxury with our Deluxe Suite, featuring separate living and sleeping areas for enhanced comfort and privacy.Indulge in ultimate luxury with separate living and sleeping areas, upscale furnishings, and breathtaking views, ensuring an unforgettable experience for discerning travelers.
 Adorned with upscale furnishings and offering breathtaking views, our suite promises an unforgettable experience tailored to discerning travelers.
                         <br />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Booked_room.aspx.cs" Inherits="Sharada.Booked_room" %>
<!DOCTYPE html>
   ...
   <body>
      <form id="form1" runat="server">
         ...
         <div class="logo-container">
            <h1 class="hotel-name">
               <img src="Images/logo.png" alt="Hotel Logo" style="font-family:'Brush Script MT'"  class="logo"/>LodgeCuisineHub
            </h1>
         </div>
         <!-- Navbar -->
         ...
         <b>
         <center>  
         <asp:Label ID="Label1" runat="server" Text="~~~YOUR BOOKED ROOMS~~~" Font-Size="38px"></asp:Label> </center></b>
         ...
         <div class="special-container" id="specialContainer">
             ...
             <b>
                 ...
                 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting1" Height="191px" Width="1458px" >
    <Columns>
        <asp:TemplateField HeaderText="BOOKING ID">
            <ItemTemplate>
                <asp:Label ID="Label2" runat="server" Text='<%# Eval("BookingID") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="ROOM NAME">
            <ItemTemplate>
                <asp:Label ID="Label4" runat="server" Text='<%# Eval("RoomName") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="TOTAL AMONUT PAID">
            <ItemTemplate>
                <asp:Label ID="Label5" runat="server" Text='<%# Eval("TotalAmountPaid") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="TOTAL DAYS">
            <ItemTemplate>
                <asp:Label ID="Label6" runat="server" Text='<%# Eval("NumberOfDays") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="CHECK IN DATE">
            <ItemTemplate>
                <asp:Label ID="Label7" runat="server" Text='<%# Eval("CheckInDate") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="CHECK OUT DATE">
            <ItemTemplate>
                <asp:Label ID="Label8" runat="server" Text='<%# Eval("CheckOutDate") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="PAYMENT">
            <ItemTemplate>
                <asp:Label ID="Label9" runat="server" Text='<%# Eval("PaymentStatus") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="OPERATION">
            <ItemTemplate>
                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="delete">CANCEL</asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                 ...
                 SelectCommand="SELECT [BookingID], [RoomType], [RoomName], [TotalAmountPaid], [NumberOfDays], [CheckInDate], [CheckOutDate], [PaymentStatus] FROM [BookedRooms] WHERE ([Email] = @Email)" >
                 <SelectParameters>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Soup.aspx.cs" Inherits="Sharada.Soup" %>
...
<center>
    <b>
        <asp:Label ID="Label1" runat="server" Text="~~~SOUPS~~~" Font-Size="38px"></asp:Label>
    </b>
...
<center>
    <table>
        <tr>
            <td>
                <asp:Image ID="Image1" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/lentil.jpg" style="margin-left: 25px; margin-right: 28px" />
                <asp:Label ID="Label2" runat="server" Text="  Lentil Soup" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
                ...
                <asp:Label ID="LabelPrice1" runat="server" Text="130 per bowl" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
             ...
             <td>
     <b><asp:Image ID="Image2" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/tom yum.jpg" style="margin-left: 25px;" /></b>
     <asp:Label ID="Label3" runat="server" Text="Tom Yum Soup" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     ...
     <asp:Label ID="Label5" runat="server" Text="130 per bowl" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     <asp:Button ID="Button1" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button1_Click"/>
             ...
             <td>
     <asp:Image ID="Image3" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/manchow.jpg" style="margin-left: 25px; margin-right: 28px" />
     <asp:Label ID="Label6" runat="server" Text=" Manchow Soup" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     ...
     <asp:Label ID="Label8" runat="server" Text="130 per bowl" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     <asp:Button ID="Button2" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button2_Click"/>
             ...
             <td>
     <asp:Image ID="Image4" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Butternut.jpg" style="margin-left: 25px; margin-right: 28px" />
     <asp:Label ID="Label9" runat="server" Text="Butternut Soup" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     ...
     <asp:Label ID="Label11" runat="server" Text="130 per bowl" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
     <asp:Button ID="Button3" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button3_Click"/>
        ...
        <tr>
            <td>&nbsp;</td>
               ...
               <tr>
           <td>
               <asp:Image ID="Image5" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/vegetable.jpg" style="margin-left: 25px; margin-right: 28px" />
               <asp:Label ID="Label12" runat="server" Text="Vegetable Soup" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
               ...
               <asp:Label ID="Label14" runat="server" Text="130 per bowl" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
            ...
            <td>
    <b><asp:Image ID="Image6" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Mushroom.jpg" style="margin-left: 25px;" /></b>
    <asp:Label ID="Label15" runat="server" Text="Mushroom Soup" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    ...
    <asp:Label ID="Label17" runat="server" Text="130 per bowl" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    <asp:Button ID="Button5" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button5_Click"/>
            ...
            <td>
    <asp:Image ID="Image7" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Minestrone.jpg" style="margin-left: 25px; margin-right: 28px" />
    <asp:Label ID="Label18" runat="server" Text="Minestrone Soup" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    ...
    <asp:Label ID="Label20" runat="server" Text="130 per bowl" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    <asp:Button ID="Button6" runat="server" Text="ORDER NOW" CssClass="order-button" style="margin-left: 105px; margin-right: 28px ; background-color:black ; color:white " Height="48px" Width="163px" OnClick="Button6_Click"/>
            ...
            <td>
    <asp:Image ID="Image8" runat="server" Height="300px" Width="325px" ImageUrl="~/Images/Tomato soup.jpg" style="margin-left: 25px; margin-right: 28px" />
    <asp:Label ID="Label21" runat="server" Text="Tomato soup Soup" style="text-align: center; display: block; margin-top: 5px;"></asp:Label>
    ...
    <asp:Label ID="Label23" runat="server" Text="130 per bowl" style="text-align: center; display: block; margin-top: 5px;" EnableTheming="False"></asp:Label>
